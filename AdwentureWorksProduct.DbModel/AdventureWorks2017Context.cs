...
namespace AdwentureWorksProduct.DbModel
{
    public partial class AdventureWorks2017Context : DbContext
    {
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            ...
            {
                optionsBuilder.UseSqlServer("Data Source=40.87.120.245,1433;Initial Catalog=AdventureWorks2017;Integrated Security=False;User ID=drem;Password=Drem816-46-93;Connection Timeout=1000");
            }
        }
